...
def call_chat_api(message: str, client_id: str) -> dict[str, Any]:
    """
    Appelle le backend FastAPI /chat.
    """
...
def display_sidebar() -> None:
    ...
    st.sidebar.markdown("---")
    st.sidebar.markdown("### Exemples de messages")
...
def display_message(role: str, content: str, metadata: dict[str, Any] | None = None) -> None:
...
def main() -> None:
    ...
    st.caption("Prototype basé sur des données fictives et une API bancaire simulée.")
